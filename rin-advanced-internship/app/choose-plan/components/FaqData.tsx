...
export const FaqData = [
    {
        id: 1, question: `How does the free 7-day trial work?`,
    ...
    {
        id: 2, question: `Can I switch subscriptions from monthly to yearly, or yearly to monthly?`,
    ...
    {
        id: 3, question: `What's included in the Premium plan?`,
    ...
    {
        id: 4, question: `Can I cancel during my trial or subscription?`,
