...
export default async function selected () {
    ...
    <div>
                ...
                ">
                    ...
                    text-[#032b41] w-40% md:text-base text-sm">{bookInfo.subTitle}</div>
                    ...
                    <div className="selected__book--content flex gap-4 md:w-6/10 w-full">
                        <figure className="book__img--wrapper h-35 w-35 min-w-[140px]">
                            <img src={bookInfo.imageLink} alt="The Lean StartUp image" className="w-full h-full" />
                        </figure>
                    <div className="selected__book--text w-full">
                        <div className="selected__book--title font-semibold
                        text-[#032b41] mb-2">{bookInfo.title}</div>
                        <div className="selected__book--author text-[#394547]
                        mb-4 text-sm">{bookInfo.author}</div>
                        <div className="selected__book--duration-wrapper flex items-center gap-2">
                            ...
                            <div className="selected__book--duration text-sm font-medium text-[#032b41]"><DisplayDuration playerInfo={bookInfo}/></div>
                        </div>
                    </div>
                    </div>
                </Link>
