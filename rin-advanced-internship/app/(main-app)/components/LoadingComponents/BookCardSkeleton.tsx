...
export default function BookCardSkeleton() {
  return (
    <div>
      <div
        className="bookCardSkeleton relative rounded-sm max-w-[200px] w-full pr-3 pb-3 snap-start
      "
      >
        <Skeleton
          height={172}
        ...
        <div className="details__wrapper--skeleton flex ">
          ...
          <div className="details__skeleton flex gap-1">
            <div className="recommended__book--details-icon flex ml-1">
